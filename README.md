...
- ExecutorService 기반 스레드 풀에서 병렬 실행
- Future를 통해 각 자동차의 이동 결과 수집
- 라운드마다 모든 자동차 이동을 병렬 처리하여 속도 향상

멀티스레드 환경에서도 안정적으로 동작하도록 다음 개념들을 적용했습니다.

- 불변 객체로 공유 상태 보호
- Atomic, synchronized, Lock 등 동시성 제어 기법 활용
- 컬렉션 동시성 문제 대비
- 스레드 풀 구조 및 ExecutorService 활용
