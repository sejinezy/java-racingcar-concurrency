...
**멀티스레드 + 동시성 제어 + 전략 기반 자동차 경주 게임**

기존 `java-racing-8` 싱글 스레드 기반 자동차 경주 게임을 
**ExecutorService 기반 멀티스레드 처리, 동시성 제어, 전략 기반 이동 로직**으로 확장한 프로젝트입니다.

본 프로젝트는 김영한님의
〈실전 자바 - 고급 1편: 멀티스레드와 동시성〉 강의에서 학습한 내용을 실제 미션에 적용해보는 것을 목표로 진행되었습니다.

[📚 멀티스레드/동시성 학습 정리 깃허브 주소](https://github.com/sejinezy/java-multithread-study)
